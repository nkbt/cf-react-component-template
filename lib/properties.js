...
export const properties = {
  ...
  'user.github': {
    ...
    message: 'Username may only contain alphanumeric characters or ' +
  ...
  'package.global': {
    description: 'Global package name (CamelCased): ',
    pattern: /^([A-Z][a-z0-9]*)+$/,
    message: 'Global package name will be exposed in `window`, so it may only contain characters',
    required: true
  },
  'package.description': {
